  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center py-1">
          <Menu
            className={
              i18n.language === "en"
                ? "text-[12px] px-2 flex  flex-col relative align-center font-kantumruy gap-2"
                : "text-[12px] px-2 flex flex-col relative align-center font-kantumruy gap-2"
            }
            ...
            {menuItems.map((item) =>
              item.children ? (
                <Menu.SubMenu
                  ...
                  title={t(item.label)}
                  className={
                    i18n.language === "km" ? "font-kantumruy" : "font-Poppins"
                  }
                >
      ...
      <Layout>
        ...
        />
        <Layout className="m-4 flex justify-between">
